...
async def send_link(message: Message):
    photo = "AgACAgIAAxkBAAILEmVExYfBT4kKoHtN5KlACDcK53CtAAK-zzEbWosgSpDc0B1xgdZGAQADAgADeQADMwQ"
    ...
    await message.answer_photo(photo,caption = caption,reply_markup=build_keyboard("VIP"))

@dp.message_handler(text='Sport')
async def send_link(message: Message):
    photo = "AgACAgIAAxkBAAILEGVExUqWzHMpdEg8TT-kMusJS9pqAAK9zzEbWosgSjoDEY6E8GllAQADAgADeQADMwQ"
    ...
    caption += "Для покупки нажмите👇" 
    await message.answer_photo(photo,caption = caption,reply_markup=build_keyboard("sport"))
